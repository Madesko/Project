 ...
 * };
 */
declare const ListPaginationContext: import("react").Context<Pick<ListControllerProps<import("..").Record>, "total" | "loading" | "perPage" | "page" | "setPage" | "setPerPage">>;
export declare type ListPaginationContextValue = Pick<ListControllerProps, 'loading' | 'page' | 'perPage' | 'setPage' | 'setPerPage' | 'total'>;
export declare const usePickPaginationContext: (context: ListControllerProps<import("..").Record>) => Pick<ListControllerProps<import("..").Record>, "total" | "loading" | "perPage" | "page" | "setPage" | "setPerPage">;
