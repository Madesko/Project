 ...
 * };
 */
declare const ListSortContext: import("react").Context<Pick<ListControllerProps<import("..").Record>, "currentSort" | "setSort">>;
export declare type ListSortContextValue = Pick<ListControllerProps, 'currentSort' | 'setSort'>;
export declare const usePickSortContext: (context: ListControllerProps<import("..").Record>) => Pick<ListControllerProps<import("..").Record>, "currentSort" | "setSort">;
